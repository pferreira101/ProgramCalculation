...
\\[\blanklineskip]%
\>[B]{}\Varid{allTransactions}\mathrel{=}\Varid{cataBlockchain}\;\alt{\p2\comp \p2}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{19}{}\<[19]%
\>[19]{}\mathbf{where}\;\Varid{aux}\;(\Varid{bc},\Varid{trans})\mathrel{=}(\plus )\;(\p2\;(\p2\;(\Varid{bc})))\;(\Varid{trans}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{allMagicNr}\mathbin{::}\Conid{Blockchain}\to [\mskip1.5mu [\mskip1.5mu \Conid{Char}\mskip1.5mu]\mskip1.5mu]\mbox{\onelinecomment  confrontar com professora}{}\<[E]%
\\
\>[B]{}\Varid{allMagicNr}\mathrel{=}\Varid{cataBlockchain}\;\alt{\Varid{singl}\comp \p1}{\Varid{aux}}{}\<[E]%
\\
\>[B]{}\hsindent{14}{}\<[14]%
\>[14]{}\mathbf{where}\;\Varid{aux}\;(\Varid{bc},\Varid{nums})\mathrel{=}(\plus )\;[\mskip1.5mu (\p1\;(\Varid{bc}))\mskip1.5mu]\;(\Varid{nums}){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{curryCell}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{curryCell}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}(\Varid{a},(\Varid{b},\Varid{c})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{curryBlock}\mathbin{::}\Conid{QTree}\;\Varid{a}\to (\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},(\Conid{QTree}\;\Varid{a},\Conid{QTree}\;\Varid{a}))){}\<[E]%
\\
\>[B]{}\Varid{curryBlock}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseQTree}\;\Varid{f}\;\Varid{g}\mathrel{=}(\Varid{f}\times\Varid{id})+(\Varid{g}\times(\Varid{g}\times(\Varid{g}\times\Varid{g})))\mbox{\onelinecomment  ?}{}\<[E]%
\\
\>[B]{}\Varid{recQTree}\;\Varid{f}\mathrel{=}\Varid{id}+(\Varid{f}\times(\Varid{f}\times(\Varid{f}\times\Varid{f})))\mbox{\onelinecomment  ?}{}\<[E]%
\\
