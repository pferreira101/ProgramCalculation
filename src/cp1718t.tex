...
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathsf{fmap}\;\Varid{f}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{f}\times(\Varid{id}\times\Varid{id}))+\Varid{id})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rotateCell}\mathbin{::}(\Varid{a},(\Conid{Int},\Conid{Int}))\to (\Varid{a},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{rotateCell}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}(\Varid{a},(\Varid{c},\Varid{b})){}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{invertCell}\mathbin{::}(\Conid{PixelRGBA8},(\Conid{Int},\Conid{Int}))\to (\Conid{PixelRGBA8},(\Conid{Int},\Conid{Int})){}\<[E]%
\\
\>[B]{}\Varid{invertCell}\;((\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a}),(\Varid{x},\Varid{y}))\mathrel{=}((\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{r})\;(\mathrm{255}\mathbin{-}\Varid{g})\;(\mathrm{255}\mathbin{-}\Varid{b})\;\Varid{a}),(\Varid{x},\Varid{y})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{invertQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp (\Varid{invertCell}+\Varid{id})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{x}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{isBackground}\mathbin{::}(\Conid{PixelRGBA8},(\Conid{Int},\Conid{Int}))\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{isBackground}\;((\Conid{PixelRGBA8}\;\mathrm{255}\;\mathrm{255}\;\mathrm{255}\;\mathrm{255}),(\Varid{x},\Varid{y}))\mathrel{=}\Conid{True}{}\<[E]%
\\
\>[B]{}\Varid{isBackground}\;((\Conid{PixelRGBA8}\;\Varid{r}\;\Varid{g}\;\Varid{b}\;\Varid{a}),(\Varid{x},\Varid{y}))\mathrel{=}\Conid{False}{}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{\Conid{Block}\mathbin{+}\Conid{Block}\mathbin{*}\Conid{Transactions}}
          ...
          \ar[d]^{\ensuremath{\Varid{g}\mathbin{+}\Varid{g}\mathbin{*}\Varid{id}}}
\\
&
...
\just\equiv{Igualdade extensional; Def-comp}
%
        \ensuremath{\begin{lcbr}\Varid{outQTree}\;(\Varid{uncurryCell}\;(\Varid{a},(\Varid{b},\Varid{c}))\mathrel{=}i_1\;(\Varid{a},(\Varid{b},\Varid{c})))\;(\Varid{outQTree}\;(\Varid{uncurryBlock}\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\mathrel{=}i_2\;(\Varid{a},(\Varid{b},(\Varid{c},\Varid{d}))))\\\cdot \end{lcbr}}
%
